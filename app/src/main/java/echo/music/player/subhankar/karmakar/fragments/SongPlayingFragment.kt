...
import echo.music.player.subhankar.karmakar.CurrentSongHelper
import echo.music.player.subhankar.karmakar.R
import echo.music.player.subhankar.karmakar.Songs
import echo.music.player.subhankar.karmakar.databases.EchoDatabase
import echo.music.player.subhankar.karmakar.fragments.SongPlayingFragment.Statified.seekBar
...
class SongPlayingFragment : Fragment() {
    ...
    object Staticated {
        ...
        fun onSongComplete() {
            ...
            if (Statified.favouriteContent?.checkifIdExixts(Statified.currentSongHelper?.songId?.toInt() as Int) as Boolean) {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        var unit = if (isLoopAllowed as Boolean) {
            Statified.currentSongHelper?.isShuffle = false
